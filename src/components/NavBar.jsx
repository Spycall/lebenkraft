  ...
  return (
    <Disclosure as="header" className="bg-white shadow">
      <div className="mx-auto ">
        ...
        <div className="flex items-center w-full h-full pl-4 gap-7">
          <img src={logo2} alt="" className="w-[100px] md:w-[150px]" />
          <nav
            aria-label="Global"
            className="hidden w-full h-full lg:flex lg:space-x-8 "
          >
            {navigation.map((item) => (
              <NavLink
                key={item.name}
